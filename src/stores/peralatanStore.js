...
export const usePeralatanStore = defineStore('peralatan', () => {
  const peralatan = ref([
    {
      ...
      keterangan: '-', status: 'Aktif', kategori: 'AWS Digitalisasi', site: 'Taman Alat',
    ...
    },
    {
      ...
      keterangan: '-', status: 'Aktif', kategori: 'Radar cuaca', site: 'Gedung Observasi',
    ...
    },
    {
      ...
      keterangan: '-', status: 'Aktif', kategori: 'AWOS', site: 'Taman Alat',
  ...
  function getBySite(site) {
    return peralatan.value.filter(p => p.site === site)
  }
